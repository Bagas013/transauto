...
@section('content')
  ...
  <div class="hero-wrap ftco-degree-bg" style="background-image: url('{{ asset('frontend/images/background-transauto.jpg') }}');"
      ...
      <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
        <div class="col-lg-8 ftco-animate">
          <div class="text w-100 text-center mb-md-5 pb-md-5">
            ...
            <p style="font-size: 18px;">Kami adalah rental terbaik di sidoarjo</p>
          ...
          <div class="row justify-content-center no-gutters">
            <div class="col-md-10 d-flex align-items-center">
              <div class="services-wrap rounded-right w-100">
                ...
                <p class="text-center mt-5"><a target="_blank" href="https://api.whatsapp.com/send/?phone=+0851234567890&text=hello+world" class="btn text-center mx-auto m-auto ml-auto btn-primary py-3 px-4">Reserve Your Perfect Car</a>
                </p>
              </div>
            </div>
          </div>
  ...
  <section class="ftco-section ftco-about">
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url({{ asset('frontend/images/bg-transauto.jpg') }});">
        </div>
        <div class="col-md-6 wrap-about ftco-animate">
          <div class="heading-section heading-section-white pl-md-5">
            <span class="subheading">About us</span>
            <h2 class="mb-4">Welcome to TransAuto</h2>
  ...
  <section class="ftco-section ftco-intro" style="background-image: url('{{ asset('frontend/images/background-menu-services.jpg') }}');">
    <div class="overlay"></div>
    <div class="container">
      <div class="row justify-content-end">
        <div class="col-md-6 heading-section heading-section-white ftco-animate">
          <h2 class="mb-3">Do You Want To Earn With Us? So Don't Be Late.</h2>
          <a target="_blank" href="https://api.whatsapp.com/send/?phone=+0851234567890&text=saya mau join driver" class="btn btn-primary btn-lg">Become A Driver</a>
        </div>
      </div>
    </div>
  </section>
